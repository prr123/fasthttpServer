...
func GenNonceStr(nonce string)(acceptStr string, err error) {
...
//    if len(accept) != acceptSize {
//        return "", fmt.Errorf("accept buffer is invalid")
//    }
...
//
    acceptStr = unsafe.String(unsafe.SliceData(accept), len(accept))

    return acceptStr, nil
}
